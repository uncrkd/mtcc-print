...
(function() {
    ...
    function init() {
        ...
        if (!gridElement) {
            console.log('[Gridstack] Grid element not found');
            return;
        }
        ...
        if (savedLayout) {
            console.log('[Gridstack] Applying saved layout to HTML before init');
        ...
        console.log('[Gridstack] Initialized with 24 columns, 20px cells');
        if (savedLayout) {
            console.log('[Gridstack] Using saved layout with', savedLayout.length, 'items');
        } else {
            console.log('[Gridstack] Using HTML default layout');
        }
    }
    ...
    function clearAllOldLayouts() {
        ...
        keysToRemove.forEach(key => {
            if (localStorage.getItem(key)) {
                console.log('[Gridstack] Removing old key:', key);
    ...
    window.toggleDashboardEditMode = function() {
        ...
        if (isEditMode) {
            ...
            addDragHandles();
            addEditModeToolbar();
            console.log('[Gridstack] Edit mode ENABLED');
        } else {
            ...
            console.log('[Gridstack] Edit mode DISABLED');
        }
    };
    ...
    window.setDefaultLayout = function() {
        ...
        console.log('[Gridstack] Saving layout:', layout);
        ...
        try {
            ...
            console.log('[Gridstack] Layout saved to:', STORAGE_KEY);
    ...
    window.resetDashboardLayout = function() {
        ...
        try {
            ...
            console.log('[Gridstack] Cleared saved layout, reloading...');
    ...
    window.debugGridLayout = function() {
        ...
        console.log('Current layout:', getCurrentLayout());
        console.log('Default layout:', DEFAULT_LAYOUT);
    };
