...
function toggleActionMenu(event, referenceCode) {
    console.log('toggleActionMenu called for:', referenceCode);
...
function openMenu(trigger, menu, referenceCode) {
    console.log('Opening menu for:', referenceCode);
    activeMenu = menu;
...
function printOrderFromMenu(referenceCode) {
    console.log('printOrderFromMenu called for:', referenceCode);
    closeAllMenus();
...
function printLabelFromMenu(referenceCode) {
    console.log('printLabelFromMenu called for:', referenceCode);
    closeAllMenus();
...
function deleteOrderFromMenu(referenceCode) {
    console.log('deleteOrderFromMenu called for:', referenceCode);
    closeAllMenus();
    ...
    console.log('Sending delete request for:', referenceCode);
...
function changeStatusFromMenu(referenceCode, newStatus) {
    console.log('changeStatusFromMenu called:', referenceCode, newStatus);
    closeAllMenus();
    ...
    console.log('Sending status update request:', referenceCode, newStatus);
...
function debugMenuSystem() {
    console.log('=== Menu System Debug Info ===');
    console.log('Active menu:', activeMenu);
    console.log('Active reference code:', activeReferenceCode);
    ...
    console.log('- printOrderFromMenu:', typeof printOrderFromMenu);
    console.log('- printLabelFromMenu:', typeof printLabelFromMenu);
    console.log('- deleteOrderFromMenu:', typeof deleteOrderFromMenu);
    console.log('- changeStatusFromMenu:', typeof changeStatusFromMenu);
}

// ===== INITIALIZATION =====
function initializeMenuSystem() {
    console.log('=== Admin Menu System Initializing ===');
    ...
    console.log('Available menu functions:', {
    ...
    setTimeout(() => {
        ...
        if (firstTrigger) {
            console.log('First menu trigger found:', firstTrigger);
            const onclick = firstTrigger.getAttribute('onclick');
            console.log('First trigger onclick:', onclick);
        } else {
            console.log('No menu triggers found on page');
        }
    }, 1000);
    
    console.log('=== Admin Menu System Ready ===');
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.querySelector('#ordersTableBody')) {
        console.log('Order table detected, initializing menu system...');
        addMenuSystemStyles();
        initializeMenuSystem();
    } else {
        console.log('No order table found, skipping menu system initialization');
    }
});

console.log('Admin Menu System Module loaded');