...
<div class="rpt-actions">
    <a href="../admin-orders.php" class="rpt-btn rpt-btn-secondary">&larr; Back to Dashboard</a>
    <button class="rpt-btn rpt-btn-primary" onclick="window.print()">Print Report</button>
</div>
