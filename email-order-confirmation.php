...
<td>
 ...
 <div style="color: #7c3aed; font-size: 14px; font-weight: 600; margin-bottom: 12px;"><?= ICON_COPY ?> Your Order</div>
 ...
 <div style="color: #6b7280; font-size: 13px; font-weight: 500; margin-bottom: 8px;">' . $width . '" ' . $height . '" &bull; ' . $material . '</div>
 ...
 <div style="color: #7c3aed; font-size: 14px; font-weight: 600; margin-bottom: 12px;"> Customer Details</div>
 <table cellpadding="0" cellspacing="0" style="width: 100%; background-color: #f8fafc; border-radius: 8px; border: 1px solid #e5e7eb;">
 <tr>
 <td style="padding: 20px;">
 ...
 <div style="color: #a16207; font-size: 11px; font-weight: 600; margin-bottom: 4px;"> Customer Note</div>
 ...
 <div style="color: #7c3aed; font-size: 14px; font-weight: 600; margin-bottom: 12px;"> Delivery Details</div>
 <table cellpadding="0" cellspacing="0" style="width: 100%; background-color: #f8fafc; border-radius: 8px; border: 1px solid #e5e7eb;">
 <tr>
 <td style="padding: 20px;">
 ...
 <div style="color: #0369a1; font-size: 11px; font-weight: 600; margin-bottom: 8px;"> Delivery Address</div>
 ...
 <div style="margin-bottom: 15px; padding: 12px; background-color: #f0f9ff; border-left: 3px solid #0284c7; border-radius: 6px;">
 <div style="color: #0369a1; font-size: 11px; font-weight: 600; margin-bottom: 4px;"><?= ICON_COPY ?> Delivery Instructions</div>
 ...
 <div style="color: #7c3aed; font-size: 14px; font-weight: 600; margin-bottom: 12px;"> Pricing Breakdown</div>
 <table cellpadding="0" cellspacing="0" style="width: 100%; background-color: #f8fafc; border-radius: 8px; border: 1px solid #e5e7eb;">
 <tr>
 <td style="padding: 20px;">
 <table cellpadding="0" cellspacing="0" style="width: 100%;">
 ...
 <div style="color: #7c3aed; font-size: 14px; font-weight: 600; margin-bottom: 8px;"> Questions?</div>
 ...
 <tr>
 <td style="padding: 20px; text-align: center;">
 <div style="color: #6b7280; font-size: 12px; font-weight: 400;">&copy; ' . $currentYear . ' Print Stuff &bull; Professional Poster Printing</div>
 ...
 <div style="margin-top: 8px;"><a href="mailto:orders@printstuff.ca?subject=Unsubscribe%20' . urlencode($referenceCode) . '" style="color: #9ca3af; font-size: 10px; text-decoration: underline;">Unsubscribe</a></div>
 </td>
 </tr>
 </table>
