/**
 * Admin Utilities Module - FIXED VERSION
        ...
        if (data.success) {
            ...
            if (window.analyticsManager && window.analyticsManager.data) {
                ...
                if (order) {
                    ...
                    console.log('[Analytics] Updated order status in cache:', referenceCode, '->', newStatus);
                }
                ...
                console.log('[Analytics] Recalculated after status change');
            }
...
function printOrderDetails() {
    console.log('Print order details called');
...
function handleQuickStatusSelect(referenceCode, newStatus, currentStatus) {
    ...
    updateOrderStatus(referenceCode, newStatus, 
        // Success callback
        (data) => {
            console.log(`Quick status update: ${referenceCode} -> ${newStatus}`);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Utilities initialization complete');
});