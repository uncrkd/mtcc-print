...
<div class="container">
    ...
    <div class="page-header" style="margin: 0;">
      <div class="page-header-left">
        <h1 class="page-title">
          <a href="?view=<?= urlencode($order['referenceCode']) ?>" class="page-title-back" title="Back to Order Details"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 6-6 6 6 6"/><path d="M3 12h14"/><path d="M21 19V5"/></svg></a>
