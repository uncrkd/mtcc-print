...
init(analyticsData) {
    ...
    setTimeout(() => {
        ...
        try {
            ...
            console.log('Top sizes chart initialized');
        } catch (error) {
        ...
        try {
            ...
            console.log('Event prefix chart initialized');
        } catch (error) {
        ...
        try {
            ...
            console.log('Turnaround chart initialized');
        } catch (error) {
        ...
        try {
            ...
            setTimeout(() => {
                console.log('[Analytics] Applying initial active events filter');
...
updateTurnaroundList() {
    ...
    console.log('Turnaround breakdown:', breakdown);
...
createCustomEventLegend(containerId, labels, data, colors, prefixData) {
    ...
    recalculateForEventsMode(mode) {
        console.log('[Analytics] recalculateForEventsMode called with mode:', mode);
        ...
        console.log('[Analytics] Active prefixes from data:', activeEventPrefixes);
        ...
        console.log('[Analytics] Filtered orders count:', orders.length);
        console.log('[Analytics] All orders count:', allOrders.length);
        ...
        console.log('[Analytics] Today date for comparison:', today);
        ...
        orders.forEach(order => {
            ...
            if (paidStatuses.includes(status)) {
                ...
                if (orderDate === today) {
                    todayRevenue += total;
                    todayOrders++;
                    console.log('[Analytics] Found today order:', order.referenceCode, 'date:', orderDate, 'total:', total);
                }
            }
        ...
        console.log('[Analytics] Recalculation complete for mode:', mode);
    }
    ...
    _updateEventChart(eventCounts) {
        if (!this.charts.eventPrefix) {
            console.log('[Analytics] eventPrefix chart not found');
            return;
        }
    ...
    _updateTimelineChart(filteredOrders) {
        console.log('[Analytics] _updateTimelineChart called with', filteredOrders.length, 'orders, period:', this.currentTimePeriod || 'yearly');
        if (!this.charts.timeline) {
            console.log('[Analytics] Timeline chart not found');
            return;
        }
        ...
        this.charts.timeline.update();
        console.log('[Analytics] Timeline updated with', filteredOrders.length, 'orders');
    }
